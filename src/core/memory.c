...
static gchar *zram_parse_active_algo(const gchar *text)
{
	const gchar *start;
	const gchar *end;
...
static void zram_read_static(Zram *z)
{
	gchar *text;
	gint64 bytes;
...
Zram *zram_new(const gchar *path, const gchar *name)
{
