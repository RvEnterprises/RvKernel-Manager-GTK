...
static void
update_ring(GtkWidget *cpi, GtkWidget *detail, gdouble frac,
...
static GtkWidget *
cpi_column(GtkWidget *cpi, GtkWidget *detail)
{
...
build_monitor_card(DashCtx *ctx)
{
        ...
        ctx->swap_section = cpi_column(ctx->swap_cpi,
                                         ctx->swap_detail);
...
GtkWidget *
page_dashboard_new(GtkWidget *window)
{
